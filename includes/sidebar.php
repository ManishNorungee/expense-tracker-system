...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="background-color: #add8e6;">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="https://mdbootstrap.com/img/new/slides/041.jpg" class="img-fluid" alt="Wild Landscape"" class="img-responsive" alt="">
            </div>
