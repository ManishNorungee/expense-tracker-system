...
<body style="background-image: url(https://i.ibb.co/8z5h6Rv/bg.jpg); background-size:cover;">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="color:white; font-weight:bold;">Home</h1>
			</div>
		</div><!--/.row-->
...
$sum_today_expense=$result['todaysexpense'];
 ?> 
						...
						<div class="easypiechart" id="easypiechart-black" data-percent="<?php echo $sum_today_expense;?>" ><span class="percent"><?php if($sum_today_expense==""){
echo "0";
} else {
...
$sum_yesterday_expense=$result1['yesterdayexpense'];
 ?> 
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-black" data-percent="<?php echo $sum_yesterday_expense;?>" ><span class="percent"><?php if($sum_yesterday_expense==""){
echo "0";
} else {
...
$sum_monthly_expense=$result3['monthlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-black" data-percent="<?php echo $sum_monthly_expense;?>" ><span class="percent"><?php if($sum_monthly_expense==""){
echo "0";
} else {
...
$sum_yearly_expense=$result4['yearlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4>Current Year's Expenses</h4>
						<div class="easypiechart" id="easypiechart-black" data-percent="<?php echo $sum_yearly_expense;?>" ><span class="percent"><?php if($sum_yearly_expense==""){
echo "0";
} else {
