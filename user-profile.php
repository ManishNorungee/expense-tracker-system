...
?>
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									<label>Email</label>
<input type="email" class="form-control" name="email" value="<?php  echo $row['Email'];?>" required="true" required="true">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="regdate" type="text" value="<?php  echo $row['RegDate'];?>" required="true">
								</div>
